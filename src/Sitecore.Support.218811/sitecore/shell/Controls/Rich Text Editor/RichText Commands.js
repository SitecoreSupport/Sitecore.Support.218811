...
//Sitecore.Support.218811 start
Telerik.Web.UI.Editor.CommandList["OpenLink"] = function (commandName, editor, args) {
    ...
    if (!id) {
        ...
        window.open("http://" + window.location.host + "/" + path + "&_z=z");
    }
};
//Sitecore.Support.218811 end
